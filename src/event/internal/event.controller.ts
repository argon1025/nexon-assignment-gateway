...
export class EventController {
  ...
  @ApiBadRequestResponse({ description: '[PARAMETER_INVALID] 유효하지 않은 파라미터', type: ErrorResponse })
  @ApiNotFoundResponse({ description: '[EVENT_100001] 이벤트를 찾을 수 없습니다.', type: ErrorResponse })
  @ApiInternalServerErrorResponse({ description: '[INTERNAL_SERVER_ERROR] 서버 오류', type: ErrorResponse })
  ...
  @ApiForbiddenResponse({ description: '[FORBIDDEN] 접근 권한이 없습니다.', type: ErrorResponse })
  @ApiUnauthorizedResponse({ description: '[INVALID_TOKEN] 유효하지 않은 토큰', type: ErrorResponse })
  @ApiNotFoundResponse({ description: '[EVENT_100002] 이벤트가 진행중이 아님', type: ErrorResponse })
  @ApiBadRequestResponse({
    description: `
    - [PARAMETER_INVALID] 유효하지 않은 파라미터
    - [EVENT_100003] 이벤트 조건을 만족하지 않음
    - [EVENT_100004] 이미 신청한 이벤트
    - [EVENT_100005] 신청할 수 있는 보상이 없음
      `,
    type: ErrorResponse,
  })
  @ApiInternalServerErrorResponse({ description: '[INTERNAL_SERVER_ERROR] 서버 오류', type: ErrorResponse })
